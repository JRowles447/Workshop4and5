          ...
          <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
            {
              data.comments.map((comment, i) => {
                ...
                return (
                  <Comment key={i} commentid={i} parent={this.state._id} author={comment.author} postDate={comment.postDate} likeCounterComment = {comment.likeCounterComment}>{comment.contents}</Comment>
                );
              })
            }
          </CommentThread>
