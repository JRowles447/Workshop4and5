  ...
  handleLikeClickComment(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLikeComment()) {
        ...
        unlikeComment(this.state.parent, this.state.commentid, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.state.parent, this.state.commentid, 4, callbackFunction);
      }
    }
  }
      ...
      <div>
        ...
        <div className="media-body">
          ...
          <br />  <a href="#" onClick={(e) => this.handleLikeClickComment(e)}>
              ...
              <a href="#"> ({data.likeCounterComment.length})</a>· <a href="#">Reply</a> ·
